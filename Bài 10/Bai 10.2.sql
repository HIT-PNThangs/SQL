...
if exists(select 'True' from master.dbo.sysdatabases where name = 'QLBH')
	drop database QLBH
go
...
-- trg_nhatkybanhang_insert. Trigger này có chức năng tự động
-- giảm số lượng hàng hiện có (Trong bảng MATHANG) khi một
-- mặt hàng nào đó được bán (tức là khi câu lệnh INSERT được thực thi trên bảng NHATKYBANHANG).
...
insert into NhatKyBanHang(ngay, nguoimua, mahang, soluong, giaban) values('1999-2-9', 'ab', '2', 30, 50)
go
